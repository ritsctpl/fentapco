...
const OPCUASecurity = ({ destination, handleChange }) => {
  ...
  return (
    ...
    <Form.Item>
      ...
      <Space direction="vertical" style={{ width: '100%', marginBottom: '16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <Input
            ...
            style={{ flex: 1 }}
            value={destination.security.applicationCertificate}
        ...
        <Checkbox
          checked={destination.security.sendCertificateChain}
      ...
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        >
          <Select
            value={destination.security.authenticationMode || 'Anonymous'}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
          <Input
            ...
            style={{ flex: 1 }}
            value={destination.security.sessionCertificate}
        ...
        <div style={{ border: '1px solid #d9d9d9', padding: '16px', borderRadius: '2px' }}>
          ...
          >
            <Input
              value={destination.security.username}
          ...
          >
            <Input.Password
              value={destination.security.password}
      ...
      <div style={{ marginBottom: '16px', border: '1px solid #d9d9d9', padding: '16px', borderRadius: '2px' }}>
        ...
        <Space direction="vertical" style={{ width: '100%' }}>
          <Form.Item label="Store Type" style={{ marginBottom: 8 }}>
            <Select
              value={destination.security.trustedServerStoreType || 'File System'}
          ...
          <Form.Item label="Folder" style={{ marginBottom: 0 }}>
            <Space>
              <Input
                value={destination.security.trustedServerFolder || 'C:/ProgramData/SAP/PCo/CertificateStore/UA Applications'}
      ...
      <div style={{ marginBottom: '16px', border: '1px solid #d9d9d9', padding: '16px', borderRadius: '2px' }}>
        ...
        <Space direction="vertical" style={{ width: '100%' }}>
          <Form.Item label="Store Type" style={{ marginBottom: 8 }}>
            <Select
              value={destination.security.rejectedServerStoreType || 'File System'}
          ...
          <Form.Item label="Folder" style={{ marginBottom: 0 }}>
            <Space>
              <Input
                value={destination.security.rejectedServerFolder || 'C:/ProgramData/SAP/PCo/CertificateStore/RejectedCertificates'}
      ...
      <div style={{ marginBottom: '16px', border: '1px solid #d9d9d9', padding: '16px', borderRadius: '2px' }}>
        ...
        <Space direction="vertical" style={{ width: '100%' }}>
          <Form.Item label="Store Type" style={{ marginBottom: 8 }}>
            <Select
              value={destination.security.trustedIssuerStoreType || 'File System'}
          ...
          <Form.Item label="Folder" style={{ marginBottom: 0 }}>
            <Space>
              <Input
                value={destination.security.trustedIssuerFolder || 'C:/ProgramData/SAP/PCo/CertificateStore/TrustedIssuers'}

...
const ReliableConnection = ({ destination, handleChange }) => {
  return (
      ...
      <Form.Item>
        ...
        <Form.Item label="Max Number of Retries" style={{ marginBottom: 16 }}>
          <InputNumber
            ...
            value={destination.reliableConnection.maxRetries || 0}
        ...
        <Form.Item label="Retry Interval" style={{ marginBottom: 16 }}>
          <InputNumber
            ...
            value={destination.reliableConnection.retryInterval || 0}
